"""Initial-state resolution with explicit ECFC contracts."""
...
def resolve_initial_state(direct: InitialState | None = None, *, inherited: Mapping[str, InitialState] | None = None, reference: str | None = None) -> InitialState:
    """Resolve a direct or inherited normalized initial state."""

...
def register_builtin_sensor_plugins(
    ...
    from .relative_state import RELATIVE_STATE_PAYLOAD_CODECS, RELATIVE_STATE_SENSOR_PLUGINS

    for descriptor in (*IMU_SENSOR_PLUGINS, *INFRARED_SENSOR_PLUGINS, *RELATIVE_STATE_SENSOR_PLUGINS, *GNSS_SENSOR_PLUGINS):
        plugins.register(descriptor)
    for codec in (*IMU_PAYLOAD_CODECS, *INFRARED_PAYLOAD_CODECS, *RELATIVE_STATE_PAYLOAD_CODECS, *GNSS_PAYLOAD_CODECS):

    ...
    return TuningCampaign(
        ...
        nodes=(
            TuningCampaignNode(
                ...
                trim_target={},
                trim_initial_guess={},
                state_scales=(0.3, 0.3, 0.5, 1.0, 1.0, 1.0),
                control_scales=(0.3, 0.3, 0.5),
                authority_requirement=LinearAuthorityRequirement(
                    "hummingbird-pseudo-hover-attitude",
                    states,
                ),
                profile_grid=NormalizedLqrProfileGrid("hummingbird-pseudo-hover"),

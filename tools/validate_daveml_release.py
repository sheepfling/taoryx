...
def main() -> int:
    ...
    commands = [
        ...
        [
            ...
            "--ungridded-policy",
            "janus_delaunay_linear_qhull_v1",
            "--compatibility-overlay-dir",
            "resources/aerospace/daveml/compatibility-overlays",
            "--quarantine-dir",
            "resources/aerospace/daveml/compatibility-overlays/quarantines",
        ],
        ...
        [python, "-m", "taoryx.runtime.cli", "daveml", "smoke", "--family", "a320_openap_3dof", "--output", "verification/daveml_a320_openap_integration.json"],
        ...
        [python, "tools/validate_daveml_alpha3_qualification.py"],
    ...
    artifacts = (
        ...
        "families/a320_openap_jsbsim_pseudo6dof/validation/roundtrip-report.json",
        ...
        "verification/daveml_f16_operating_points_evidence.json",
        "verification/daveml_f16_overlay_qualification.json",
        "verification/daveml_f16_controller_qualification.json",

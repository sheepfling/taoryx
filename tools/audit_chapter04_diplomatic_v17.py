...
JSON_PATH = ROOT / "qa" / "chapter04_diplomatic_audit_v17.json"
MARKDOWN_PATH = ROOT / "qa" / "chapter04_diplomatic_audit_v17.md"
...
def _render_markdown(report: dict[str, Any]) -> str:
    lines: list[str] = [
        "# TAOS Chapter 4 diplomatic-transcription audit - Version 17",
        "",
        "This targeted audit measures the eight Chapter 4 regions restored in the second ranked diplomatic batch. "
        ...
        "",
        "| Section | Source pages | V16 token recall | V17 token recall | Change | V16 bigram | V17 bigram | Change |",
        "|---|---|---:|---:|---:|---:|---:|---:|",
    ]
    ...
    lines.extend(
        [
            ...
            f"- Version 17 candidate tokens: {aggregate['candidate_tokens']:,}",
            ...
            "## Integrity checks",
            "",
            "- The ten Version 15 `.tbl` and `.prb` parser fixtures remain byte-for-byte unchanged through Version 17.",
            "- Separate `.txt` output listings preserve the historical printouts while keeping parser fixtures invariant.",
            "- No numbered equation, table, or figure was renumbered or replaced by this pass.",
            "- The restored Ballistic Rocket and intercept output pages are semantic text transcriptions; they were not regenerated by running TAOS 96.0.",
            "",
        ]
    )
    return "\n".join(lines)

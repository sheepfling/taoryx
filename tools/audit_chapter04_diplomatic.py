...
JSON_PATH = ROOT / "qa" / "chapter04_diplomatic_audit_v16.json"
MARKDOWN_PATH = ROOT / "qa" / "chapter04_diplomatic_audit_v16.md"
...
def _render_markdown(report: dict[str, Any]) -> str:
    lines: list[str] = [
        "# TAOS Chapter 4 diplomatic-transcription audit - Version 16",
        "",
        "This targeted audit measures the eight Chapter 4 regions restored in the first ranked diplomatic batch. "
        ...
        "",
        "| Section | Source pages | V15 token recall | V16 token recall | Change | V15 bigram | V16 bigram | Change |",
        "|---|---|---:|---:|---:|---:|---:|---:|",
    ]
    ...
    lines.extend(
        [
            ...
            f"- Version 16 candidate tokens: {aggregate['candidate_tokens']:,}",
            ...
            "## Integrity checks",
            "",
            "- The ten Version 15 `.tbl` and `.prb` parser fixtures are byte-for-byte unchanged.",
            "- Separate `.txt` input listings preserve the identifiers printed in the source while keeping parser fixtures invariant.",
            "- No numbered equation, table, or figure was renumbered or replaced by this pass.",
            "- The restored Ballistic Reentry output pages are semantic text transcriptions; they were not regenerated by running TAOS 96.0.",
            "",
        ]
    )
    return "\n".join(lines)

...
class F16RacetrackRunner:
    ...
    def _sample(
        ...
        return {
            ...
            "residual_force_x_n": float(requested_wrench["total_force_x_n"] - achieved_wrench["total_force_x_n"]),
            "residual_moment_x_nm": float(requested_wrench["total_moment_x_nm"] - achieved_wrench["total_moment_x_nm"]),
            "residual_moment_y_nm": float(requested_wrench["total_moment_y_nm"] - achieved_wrench["total_moment_y_nm"]),
            "residual_moment_z_nm": float(requested_wrench["total_moment_z_nm"] - achieved_wrench["total_moment_z_nm"]),

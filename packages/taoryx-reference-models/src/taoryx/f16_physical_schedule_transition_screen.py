    ...
    def estimate(self, composition: CompiledVehicleComposition) -> MissionCapabilityEstimate:
        ...
        return MissionCapabilityEstimate(
            ...
            diagnostics=(
                ...
                "the endpoint interpolation policy is explicit; wind, mass, navigation, envelope, and qualification gates remain separate",
            ),
            manifest=manifest,
            plan=plan,
        )
...
def execute_f16_physical_schedule_transition_screen(
    ...
    result = F16PhysicalScheduleTransitionScreenExecution(
        ...
        claim_boundary=(
            ...
            "path, wind/mass robustness result, full envelope, or flight qualification."
        ),
    )

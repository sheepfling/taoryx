...
- [ ] **TAOS-ALG-COORD-020 — Generic Unit-Vector Coordinate Transformation**
  - Target: `taos_math.linalg.transform_vector`
  - Priority / complexity: P0 / low
  - Dependencies: none
- [ ] **TAOS-ALG-OPT-004 — Forward and Central Numerical Gradients**
  - Target: `taos_math.numeric.finite_difference_jacobian`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-SEARCH-001 — One-Dimensional Newton-Raphson Root Search**
  - Target: `taos_math.searches.newton_root`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-SEARCH-002 — Bracketed Secant Root Search**
  - Target: `taos_math.searches.secant_bracketed_root`
  - Priority / complexity: P0 / low
  - Dependencies: none
- [ ] **TAOS-ALG-SEARCH-004 — Golden-Section Minimization**
  - Target: `taos_math.searches.golden_section_minimize`
  - Priority / complexity: P0 / low
  - Dependencies: none
- [ ] **TAOS-ALG-TABLE-002 — N-Dimensional Linear Interpolation and Extrapolation**
  - Target: `taos_runtime.tables.interpolate_nd`
  - Priority / complexity: P0 / high
  - Dependencies: none
- [ ] **TAOS-ALG-PRB-011 — Units and Output-Format Resolution**
  - Target: `taos_runtime.units.resolve_units_and_formats`
  - Priority / complexity: P1 / high
  - Dependencies: none
- [ ] **TAOS-ALG-SEARCH-003 — Parabolic Root Search**
  - Target: `taos_math.searches.parabolic_root`
  - Priority / complexity: P1 / high
  - Dependencies: none
- [ ] **TAOS-ALG-SEARCH-005 — Parabolic Minimization**
...
- [ ] **TAOS-ALG-ENV-002 — Atmosphere Model Setup and Layer Precomputation**
  - Target: `taos_math.atmosphere.prepare_atmosphere_model`
  - Priority / complexity: P0 / high
  - Dependencies: TAOS-ALG-ENV-003
- [ ] **TAOS-ALG-ENV-003 — Reference Gravity and Geopotential Altitude**
  - Target: `taos_math.atmosphere.geopotential_altitude`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-ENV-004 — Layered Atmosphere Thermodynamic Properties**
  - Target: `taos_math.atmosphere.atmosphere_properties`
  - Priority / complexity: P0 / very_high
  - Dependencies: TAOS-ALG-ENV-002, TAOS-ALG-ENV-003
- [ ] **TAOS-ALG-GRAV-002 — Associated Legendre Function Evaluation**
  - Target: `taos_math.gravity.associated_legendre`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-GRAV-003 — Spherical-Harmonic Normalization Conversion**
  - Target: `taos_math.gravity.harmonic_normalization_factor`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-GRAV-005 — J2-Only Gravity Acceleration**
...
- [ ] **TAOS-ALG-PRB-012 — Wind Input Resolution**
...
- [ ] **TAOS-ALG-GUID-003 — Parabolic Guidance Transition**
  - Target: `taos_math.guidance.parabolic_guidance_correction`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-GUID-004 — Cubic Guidance Transition**
  - Target: `taos_math.guidance.cubic_guidance_correction`
  - Priority / complexity: P0 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-GUID-005 — Multidimensional Newton-Raphson Control Solve**
...
- [ ] **TAOS-ALG-GUID-009 — Flight-Path Limit Arbitration**
  ...
  - Priority / complexity: P2 / high
  - Dependencies: none
- [ ] **TAOS-ALG-GUID-008 — Range-Insensitive Axis Search**
...
- [ ] **TAOS-ALG-EXEC-002 — Vehicle, Segment, and Output Runtime Structure Construction**
  - Target: `taos_runtime.runtime_model.build_runtime_problem`
  - Priority / complexity: P1 / high
  - Dependencies: TAOS-ALG-PRB-003, TAOS-ALG-TABLE-001
- [ ] **TAOS-ALG-EXEC-003 — Synchronized Multi-Vehicle Trajectory Loop**
...
- [ ] **TAOS-ALG-EXEC-004 — Common Next-Time-Step Selection**
  - Target: `taos_runtime.engine.get_next_time_step`
  - Priority / complexity: P1 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-EXEC-005 — Integrate All Active Vehicles One Step**
  - Target: `taos_runtime.engine.integrate_active_vehicles`
  - Priority / complexity: P1 / high
  - Dependencies: TAOS-ALG-DYN-003, TAOS-ALG-EXEC-009
- [ ] **TAOS-ALG-EXEC-006 — Segment Final-Condition Detection and Refinement**
...
- [ ] **TAOS-ALG-EXEC-009 — Complete Derivative Calculation Pipeline**
...
- [ ] **TAOS-ALG-PRB-003 — Trajectory Initial-Condition Resolution**
...
- [ ] **TAOS-ALG-TABLE-007 — Full-Table If/Label/Goto Control Flow**
...
- [ ] **TAOS-ALG-TABLE-009 — Multiple Table Reference Evaluation and Accumulation**
  - Target: `taos_runtime.tables.evaluate_table_references`
  - Priority / complexity: P1 / medium
  - Dependencies: TAOS-ALG-TABLE-003
- [ ] **TAOS-ALG-PRB-007 — Survey Value Generation and Cartesian Nesting**
  - Target: `taos_runtime.surveys.generate_survey_cases`
  - Priority / complexity: P2 / medium
  - Dependencies: none
- [ ] **TAOS-ALG-PRB-008 — Search Loop Construction, Nesting, and Execution**
  - Target: `taos_runtime.search_runtime.execute_search_loops`
  - Priority / complexity: P2 / very_high
  - Dependencies: TAOS-ALG-SEARCH-003
- [ ] **TAOS-ALG-PRB-009 — Survey Summary Variable Aggregation**
...
- [ ] **TAOS-ALG-OPT-001 — TAOS Nonlinear Programming Problem Construction**
...
- [ ] **TAOS-ALG-PRB-010 — *Optimize Block Runtime Mapping**

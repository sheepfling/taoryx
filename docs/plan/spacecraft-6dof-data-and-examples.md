# Taoryx spacecraft 6DOF data and example plan

Spacecraft have their own **6DOF data and qualification track**, with
...
This document captures the data contracts, scenarios, validation tests,
maturity levels, and definition of done for the space track.

The parametric family expansion is documented separately in
[spacecraft-parametric-family-expansion.md](spacecraft-parametric-family-expansion.md).
It supplies source-anchored notional ranges and coherent sizing flows without
claiming exact subsystem specifications for the named public architectures.

The corrected fixture values and milestone gates are maintained in
[spacecraft-parametric-fixtures-engineering-review.md](spacecraft-parametric-fixtures-engineering-review.md).

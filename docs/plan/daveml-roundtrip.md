...
- a reproducible canonical/runtime L0–L4 round-trip report generated by the
  catalog and release-gate validators.
...
- The official two-dimensional ungridded fixture remains quarantined because
  ...
  do not provide enough authority to select a legacy triangulation policy; see
  the [DAVE-ML interpolation reference](https://daveml.org/DTDs/prod/Ref/interpolation.html).

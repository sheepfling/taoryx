# Simulation Runtime discovery, diagnosis, and bundles
...
[`verification/simulation_runtime_scenario_catalog.yaml`](../../verification/simulation_runtime_scenario_catalog.yaml).
...
and claim boundaries for the Simulation Runtime regression set.
...
taoryx scenario bundle hl20-source-release-pseudo6dof \
  --output-dir artifacts/simulation-runtime/hl20-source-release-pseudo6dof

taoryx scenario manifest validate \
  artifacts/simulation-runtime/hl20-source-release-pseudo6dof/run-manifest.json

taoryx artifact validate \
  artifacts/simulation-runtime/hl20-source-release-pseudo6dof/run/run-artifact.json
```
...
- `run-manifest.json` — the schema-versioned Simulation Runtime identity, runtime,

...
This is the reflection/capability part of the external provider/consumer
layer. If you are deciding whether to publish this artifact from a foreign
backend or to add a model inside TAORYX, see [Developer interface
...
and use [`taoryx model overview`](../architecture/vehicle-model-cards.md) for a reviewer-facing

...
ROOT = Path(__file__).resolve().parents[1] / "fixtures" / "simple_aero_v1"
pytestmark = pytest.mark.simple_aero


def test_simple_aero_simple_aero_manifest_matches_bundled_files() -> None:
...
def test_simple_aero_simple_aero_examples_share_the_expected_scaffold() -> None:

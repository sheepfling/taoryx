"""Fast vertical Composition proof for the runnable F-16 S.119 reduction."""
...
def test_f16_composition_compiles_and_executes_the_real_reduced_racetrack(
    ...
    result = execute_reduced_fixed_wing_composition(composition, tmp_path / "f16-racetrack")
...
def test_f16_physical_control_screens_run_through_the_composition_factory(
    ...
    composition = compile_vehicle_composition(load_vehicle_composition_request(ROOT / "examples/vehicle_composition" / filename))

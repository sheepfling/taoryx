...
def test_a320_composition_compiles_and_executes_the_documented_racetrack(
    ...
    result = execute_reduced_fixed_wing_composition(composition, tmp_path / "a320-racetrack")
...
def test_a320_native_coordinate_lqi_is_a_first_class_batch_composition_endpoint(
    ...
    batch = execute_vehicle_composition_batch(composition, tmp_path / "a320-native-lqi")
...
def test_a320_jsbsim_surrogate_realization_uses_the_exact_common_batch_and_session_paths() -> None:

...
from taoryx.spectre_builder import FixedLD3DOFParameters, SpectreTrajectoryBuilder, build_fixed_ld_3dof
...
def test_fixed_ld_builder_output_is_parser_compatible_and_writes_manifest(tmp_path) -> None:
    build = SpectreTrajectoryBuilder(
        FixedLD3DOFParameters(
            scenario_id="x8-spectre-smoke",

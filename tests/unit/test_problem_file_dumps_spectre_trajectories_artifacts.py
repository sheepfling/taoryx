...
from taoryx.fixtures.spectre_trajectory_artifacts import build_problem_plot_series
...
def test_spectre_trajectory_plot_generator_uses_expected_labels_and_series() -> None:
    spec = load_spec(SPEC)

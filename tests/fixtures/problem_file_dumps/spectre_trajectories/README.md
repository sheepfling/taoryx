...
The per-case structured `spectre_metadata` blocks retain the solution-specific
knobs from the Spectre context dump, including left/right direction, maneuver

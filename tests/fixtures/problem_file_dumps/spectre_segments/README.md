# Spectre Segment Problem-File Dump

This is the initial Spectre leaf under the problem-file dump workspace.

The checked-in translated fixtures are generated from
[`spec.yaml`](spec.yaml). The source seed corpus is in
[`../../spectre_simple_aero_v1/`](../../spectre_simple_aero_v1/), which holds a
...
The newer `INBOX/darts-spectre-dump-v2/` context adds the segment and solution
...
For organization, we treat the Spectre leaf as a staged translation area with
...
Use this area for future Spectre problem-file material that needs to stay
